...
const aboutTranslations: Record<LangCode, any> = {
  ...
  hr: {
    heroTitle: 'Tko smo / Naša misija',
    heroSubtitle: 'Vlasnici smo franšize Hollywood Sustav za kosu® za područje cijele Europe.',
    spelaSemeTitle: 'Špela Šeme',
    spelaSemeP1: 'Voditeljica odjela Sustavi za kosu®, dr. Špela Šeme, aktivna članica NAAF-a, ima više od 40 godina iskustva s prevladavanjem gubitka kose i sama nosi Sustav za kosu®. Zato iz osobnog iskustva poznaje sve važne pojedinosti o postavljanju, održavanju i korištenju sustava.',
    spelaSemeP2: 'Dr. Špela Šeme aktivno surađuje s međunarodnim stručnjacima na istraživanju uzroka alopecije areate i redovito organizira edukativne seminare. S novim saznanjima upoznaje i zainteresirano medicinsko osoblje. Članovi našeg tima imaju osobno iskustvo s gubitkom kose ili se s njime susreo netko od njihovih bližnjih.',
    specialistsTitle: 'Ponosni smo što smo specijalisti za savjetovanje pri:',
    specialistsList: [
      'potpunom ili djelomičnom gubitku kose zbog stresnih čimbenika',
      'nekirurškoj nadoknadi kose uz pomoć Sustava za kosu®',
      'potpunom ili djelomičnom gubitku kose zbog kemoterapije i drugih liječenja',
      'psihološkom i estetskom prevladavanju posljedica alopecije areate',
      'estetskom rješavanju muške ili ženske ćelavosti i prorijeđene kose',
    ],
    spelaSemeP3: 'Dr. Špela Šeme također je pokretačica i voditeljica prve slovenske Grupe za samopomoć pri gubitku kose te organizira redovite sastanke za osobe koje se suočavaju s gubitkom kose.',
    skupinaReadMore: 'Pročitajte više o Grupi za samopomoć',
    goalsTitle: 'Naši ciljevi',
    goalsDesc: 'Cilj našeg odjela jest pomoći ljudima koji pate od djelomičnog ili potpunog gubitka kose. Naša pomoć obuhvaća psihološko i estetsko prevladavanje gubitka te uključuje:',
    goalsList: [
      'informacije o vizualnim tehnikama i pomagalima koja ublažavaju nedostatak kose, obrva i trepavica',
      'informacije i savjete za lakše prevladavanje najtežih psiholoških izazova povezanih s gubitkom kose',
      'objašnjenje tehnika koje pomažu pri depresiji i apatiji koje često prate gubitak kose',
      'organiziranje susreta s ljudima sličnih iskustava kako se nitko ne bi osjećao sam i neshvaćen',
      'informiranje o svjetskim novostima na području gubitka kose',
      'pomoć pri organizaciji posjeta godišnjoj konferenciji NAAF-a u SAD-u',
      'podizanje svijesti o gubitku kose putem televizije, radija, časopisa, predavanja i susreta u zdravstvenim ustanovama',
    ],
    closingP1: 'Mogućnost doprinosa boljoj kvaliteti života ljudi velik je dar. Biti dio poduzeća s tako plemenitom misijom posebna je radost i čast.',
    closingP2: 'Informacije o sastancima Grupe za samopomoć dostupne su u rubrici Kontakti.',
    brandTitle: 'Zaštitni znak',
    brandP1: 'HOLLYWOOD LASNI SISTEM® i HOLLYWOOD HAIR SYSTEM® registrirani su zaštitni znakovi sustava za kosu koji nisu obične perike, već alternativa presađivanju kose. Prodaje ih isključivo Fi-potencial d.o.o. i njegovi poslovni partneri.',
    brandP2: 'Naziv Hollywood Lasni Sistem® i sve njegove izvedenice zakonski su zaštićeni pri Slovenskom uredu za intelektualno vlasništvo. Jedini vlasnik zaštitnog znaka je Fi-Potencial d.o.o. iz Kranja. Naziv smiju koristiti samo korisnici franšize odnosno nositelji licence.',
    brandP3: 'Gdje možete kupiti pravi Sustav za kosu®? Svaka zloupotreba naziva i neovlaštena uporaba fizičkih ili pravnih osoba bit će pravno sankcionirana.',
    brandP4: 'Tako unaprijed štitimo klijente od jeftinih kopija koje se pokušavaju prodavati pod istim nazivom. Zbog nekvalitetnih materijala, poput obojene azijske kose ili sintetike, takvi se proizvodi raspadnu za nekoliko mjeseci i često snažno nadražuju kožu, osobito zbog medicinski neprovjerenih ljepila.',
    brandP5: 'Pravi Hollywood Sustav za kosu® dostupan je isključivo u Kranju (Fi Potencial d.o.o.) i na otoku Krku (Villa Splendissima d.o.o.).',
  },
  en: {
