...
const shortTestimonialsMap: Record<LangCode, ShortTestimonial[]> = {
  ...
  hr: [
    { name: 'Janez', quote: 'Izvrsna usluga za klijente. Iznimno ljubazni i učine sve da budete zadovoljni.' },
    { name: 'Erika', quote: 'Osjećam se lagano i opušteno, kao da imam vlastitu kosu. Ponovno mogu voziti bicikl, vježbati i plivati bez brige…', fullId: 'erika' },
    { name: 'James B.', quote: 'Genessa i Eva su najbolje!' },
    { name: 'Andrej', quote: 'Uvijek izvrsno!' },
    { name: 'Christine', quote: 'Sa sustavom za kosu ponovno sam oživjela! Od prvog trenutka osjećala sam se slobodno i bez ograničenja…', fullId: 'christine' },
    { name: 'Rok', quote: 'Odlično iskustvo, svi su ljubazni i sjajno rade svoj posao.' },
    { name: 'Anonimna klijentica', quote: 'Vrlo sam zadovoljna sustavom, a oduševljeni su i moj partner, obitelj i prijatelji.' },
    { name: 'Luka', quote: 'Savršeno u svakom pogledu!' },
    { name: 'Jure', quote: 'Uvijek ugodno iskustvo.' },
    { name: 'Katja', quote: 'Sustav se savršeno uklopio s mojom kosom. Izgleda potpuno prirodno, a najbolje je što zaboravite da ga nosite…', fullId: 'katja' },
    { name: 'Chris Ishida', quote: 'Apsolutno savršenstvo! Predivan rezultat i vrhunski profesionalno osoblje!' },
    { name: 'Dorothy R.', quote: 'Uvijek izvrsna usluga i ljubazno gostoprimstvo.' },
    { name: 'Mateja, 22 godine', quote: 'Osjećaj je neopisiv, sustav je lagan, a kosa predivna. Plivala sam čak i pod vodom. Rub je nevidljiv…', fullId: 'mateja' },
    { name: 'Robert Olds', quote: 'Svi su bili vrlo ljubazni i susretljivi. Usluga je bila izvrsna.' },
    { name: 'Chuck Sweetman', quote: 'Clarissa Eva je NAJBOLJA!' },
    { name: 'Thomas A.', quote: 'Obožavam ovo mjesto, svi su uvijek vrlo ljubazni i gostoljubivi.' },
    { name: 'Giacomo Tocco', quote: 'Uvijek izvrsna usluga!' },
    { name: 'Eva, 18 godina', quote: 'Susret sa Špelom ugodno me iznenadio. Sustav za kosu sada mi omogućuje normalan život…', fullId: 'eva' },
    { name: 'Thomas Proulx', quote: 'Nevjerojatni ljudi i usluga – uvijek!' },
    { name: 'Marvin B.', quote: 'Izvrsna usluga. Salvador radi odličan posao.' },
    { name: 'Victor Castaneda', quote: 'Uvijek odlično iskustvo! Sal i ostalo osoblje su najbolji.' },
    { name: 'Miha iz Ljubljane', quote: 'Sustav nosim već godinu dana. Plivam, igram nogomet, a ni jak vjetar nije problem…', fullId: 'miha' },
    { name: 'Richard Kletter', quote: 'Eva je uvijek brza i izvrsna u svom poslu.' },
    { name: 'Merima, 15 godina', quote: 'Nakon kemoterapije ostala sam bez kose. Sa Hair System® dobila sam istu kosu kakvu sam imala prije bolesti…', fullId: 'merima' },
    { name: 'Shad Meshad', quote: 'Ljubazni, vješti i opušteni. Osjećao sam se vrlo ugodno.' },
    { name: '22-godišnji student', quote: 'Sustav se doslovno stopio s mojom kosom. Nitko još nije primijetio da ne nosim vlastitu kosu…', fullId: 'student' },
    { name: 'Oduševljeni korisnik', quote: 'Nevjerojatan je u svakom pogledu i odlično se drži. Kao da sam iz starog automobila prešao u Mercedes…', fullId: 'navdusenec' },
    { name: 'S.A., 50 godina', quote: 'Otkad ga nosim mnogo sam samouvjereniji i izgledam barem deset godina mlađe…', fullId: 'sa-50let' },
    { name: 'Bojči', quote: 'Vratila sam golemo samopouzdanje. Mogu trčati, plesati, skakati i plivati…', fullId: 'bojci' },
    { name: 'Marjana', quote: 'Sa sustavom za kosu nema straha. Mogu plivati, roniti i tuširati se na plaži…', fullId: 'marjana' },
    { name: 'Janka iz Celja', quote: 'Ponovno uživam u sportu, plivanju i sauni. Više mi ni vjetar ne smeta. ŽIVIM!…', fullId: 'janka' },
  ],
  en: [
