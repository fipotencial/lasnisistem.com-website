...
const t = {
  ...
  hr: {
    heroSuperTitle: 'Hibridni sustavi',
    heroTitle: 'Spoj Hollywood Sustava za kosu® i perike',
    heroSubtitle: 'Za muškarce i žene',
    introTitle: 'Hibridni sustavi za muškarce i žene od najkvalitetnije europske kose!',
    introP1: 'Strojno su izrađeni i dostupni na zalihi, stoga su cjenovno pristupačniji od Hollywood Sustava za kosu®, iako su izrađeni od europske kose jednake vrhunske kvalitete i dostupni u svim bojama. Mogu se bojiti, pramenovati, kovrčati i ravnati. Visoka kvaliteta kose doista će vas oduševiti!',
    introP2: 'Hibridni sustavi za muškarce i žene omogućuju vam da s kosom radite upravo ono što želite. Možete se prema njoj ponašati kao da je vaša i ponovno živjeti punim životom!',
    whyTitle: 'Zašto nisu poput običnih jeftinih perika?',
    whyP1: 'Zato što se za njih koristi samo najkvalitetnija netretirana europska kosa – ista kao za Hollywood Sustave za kosu® – a sprijeda imaju sličnu mrežicu kao Hollywood Sustav za kosu®.',
    whyP2: 'Hibridni sustavi posebno su prikladni za osobe koje prolaze kemoterapiju ili se suočavaju s drugim bolestima. Organizam je već opterećen kemikalijama pa mu nisu potrebne dodatne u obliku jeftinije kemijski obrađene kose ili sintetičkih vlakana. Dodatna je prednost što su, ako je željena boja na zalihi, obično dostupni u roku od tjedan dana.',
    galleryMenTitle: 'Muški hibridni sustavi',
    galleryWomenTitle: 'Ženski hibridni sustavi',
    partnerText: 'Za detaljnije informacije o svim dostupnim modelima posjetite web-stranicu našeg partnera',
    houseOfEuropeanHair: 'House of European Hair',
    partnerMenLink: 'Muški hibridni sustavi →',
    partnerWomenLink: 'Ženski hibridni sustavi →',
    partnerCta: 'Kada odaberete hibridni sustav koji vam se sviđa, kontaktirajte nas i pomoći ćemo vam pri narudžbi ili odabiru najprikladnijeg modela.',
    contactUs: 'Kontaktirajte nas',
    front: 'Sprijeda',
    back: 'Straga',
  },
