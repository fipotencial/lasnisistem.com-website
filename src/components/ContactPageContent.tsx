...
const contactTranslations: Record<LangCode, {
  ...
  hr: {
    ...
    heroSubtitle: 'Rezervirajte diskretne i stručne konzultacije ili nam pošaljite svoja pitanja.',
    formName: 'Ime i prezime',
    formEmail: 'Adresa e-pošte',
    formPhone: 'Broj telefona',
    formMessage: 'Vaša poruka',
    formSubmit: 'Pošalji poruku',
    formSending: 'Šaljem...',
    formSuccess: 'Vaša je poruka uspješno poslana. Odgovorit ćemo vam u najkraćem roku.',
    formDisclaimer: 'Vaši su podaci povjerljivi i ne dijelimo ih s trećim osobama.',
    infoTitle: 'Kontaktni podaci',
    address: 'Adresa',
    addressValue: 'Komenskega 1\n4000 Kranj, Slovenija',
    phone: 'Telefon',
    ...
    emailValue: 'info@lasnisistem.com',
    hours: 'Radno vrijeme',
    hoursValue: 'Ponedjeljak – subota: prema dogovoru',
    hoursSat: '',
    mapTitle: 'Naša lokacija',
    discretion: 'Potpuna diskrecija',
    discretionText: 'Svake se konzultacije odvijaju u potpuno privatnom prostoru. Vaša je privatnost naš prioritet.',
  },
  en: {
