...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const titles: Record<string, string> = {
    ...
    hr: 'Rješenje za gubitak kose | Hollywood Sustav za kosu®',
  ...
  const descriptions: Record<string, string> = {
    ...
    hr: 'Gubitak kose i ćelavost više nisu sudbina. Hollywood Sustav za kosu® diskretno je i prirodno rješenje. 25 godina iskustva i savjetodavni studio u Kranju.',
